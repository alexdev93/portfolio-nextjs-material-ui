      ...
      <HeaderContent className="header-content">
        ...
        <RightHeader className="right-header">
          <AnimatedBox variant="fadeInUp">
            <Name className="name">
              Hi, I&apos;m <span>Alemayehu Mekonen.</span>A Web Developer.
            </Name>
          </AnimatedBox>
          <AnimatedBox variant="fadeIn">
            <Description style={{ fontStyle: "italic" }}>
              ...
              emphasizes my dedication to creating customized and visually
              appealing website that accurately reflect the brand and goals of
              each client.
            </Description>
          </AnimatedBox>
          <MainButton
